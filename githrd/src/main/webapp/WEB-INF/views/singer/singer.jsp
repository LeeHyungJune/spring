...
<body>
	<div class="w3-content mxw700">
		<div class="w3-col w3-purple w3-center w3-padding w3-margin-bottom">
			<h1><i class="fa fa-users"></i>가수 정보</h1>
		</div>
		<div class="w3-col w3-center" >
			...
			<div class="w3-third" style="padding-left: 5px;">
				<select class="w3-col w3-select w3-border w3-center" id="gen">
					...
					<option value="남자" class="w3-text-blue"><i class="fa fa-person"></i>남자</option>
					<option value="여자" class="w3-text-pink"><i class="fa fa-person-dress"></i>여자</option>
				</select>
			</div>
			<div class="w3-third" style="padding-left: 5px;">
				<select class="w3-col w3-select w3-border w3-center" id="stype">
					<option disabled selected>::: 타입 선택 :::</option>
					<option value="S" class="fa fa-user">솔로</option>
					<option value="G" class="fa fa-users">그룹</option>
				</select>
			</div>
